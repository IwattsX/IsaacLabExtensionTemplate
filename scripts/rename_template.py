...
It renames all the occurrences of Ext_Robot_Arm (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the Ext_Robot_Arm folder
        os.rename(
            os.path.join(root_dir_path, "exts", "Ext_Robot_Arm", "Ext_Robot_Arm"),
            os.path.join(root_dir_path, "exts", "Ext_Robot_Arm", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "Ext_Robot_Arm"), os.path.join(root_dir_path, "exts", new_name))
